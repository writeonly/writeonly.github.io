...
Kod assemblera **[EAS]** jest dostępny na [GitHubie](https://github.com/helvm/helpa/tree/v0.2.1.0).
Kod interpretera **[ETA]** też jest dostępny na [GitHubie](https://github.com/helvm/helma/tree/v0.6.0.0).
