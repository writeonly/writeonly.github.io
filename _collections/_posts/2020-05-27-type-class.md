...
Interpreter [BrainFucka] będzie częścią projektu [HelMA],
a [HelMA] częścią większego projektu [HelVM] (wymawiaj Helium).
...
Kod jest dostępny na [Githubie](https://github.com/helvm/helma/tree/v0.2.0.0).
